...
use Library\Cli\SchematicNewConsoleApp;
...
/**
 * @package SchematicNewConsoleApp
 *
 * The main new migrations class which runs the maintenance on the database
 */
$application->add(new SchematicNewConsoleApp());
